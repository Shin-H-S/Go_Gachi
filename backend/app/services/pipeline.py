...
from app.ml.text_gen import ad_prompt
from app.models.schemas import AdGenerationInput, GeneratedAsset
from app.storage.files import new_id, output_path, output_url, save_upload
...
async def create_ad(
    ...
    prompt = ad_prompt(ad_input, size)
    ...
    final_image = fit_size(generated_bytes, size)
