...
def _copy_system_prompt(copy_mode: CopyMode) -> str:
    ...
    return (
        ...
        "Do not transliterate Korean into English or mix Korean and English unless the user explicitly provided them. "
        "Do not output any text beyond the required JSON. "
        "Headlines should be short, punchy, and designed for visual emphasis. "
        "For the headline field, generate a Korean advertising headline suitable for image banners. "
        ...
        "Avoid CTA phrases, commands, quotation marks, emojis, hashtags, or punctuation in headline. "
        ...
        "For rewrite, prefer short, slogan-style phrases that preserve the user's original product theme, taste, mood, and benefit. "
        "Use the examples only as style references, not as fixed content: '깊은 우유 풍미의 라떼', "
        "'우유가 살아있는 라떼', '진한 우유의 깊은 맛', or '우유의 깊이를 담다'. "
        "Keep the output concise, natural, and commercial without forcing any specific ingredient, flavor, or product theme. "        
